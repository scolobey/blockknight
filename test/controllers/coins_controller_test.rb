...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { description: @coin.description, name: @coin.name, team: @coin.team, ticker: @coin.ticker } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { description: @coin.description, name: @coin.name, team: @coin.team, ticker: @coin.ticker } }
