class CoinsController < ApplicationController
  ...
  private
    ...
    def coin_params
      params.require(:coin).permit(:name, :ticker, :supply, :description, :team, :key_value_proposition, :twitter, :github, :website, :concerns, :community, :all_tags, :archive, :whitepaper)
    end
